...
<p class="muted">Every order here was created only after you explicitly confirmed it. This is an MVP demo catalogue, so "redirect" is simulated rather than a real store checkout.</p>
